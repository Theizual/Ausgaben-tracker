...
const makeDemoTransactions = (): Transaction[] => {
    ...
    return [
        ...
        { id: 'dev-3', amount: 7.50, description: 'Parkgebühren Innenstadt', categoryId: 'cat_auto', date: subDays(now, 2).toISOString(), isDemo: true, tagIds: ['dev-tag-4'], lastModified: now.toISOString(), version: 1, createdBy: standardUser },
        ...
        { id: 'dev-6', amount: 15.45, description: 'Shampoo und Duschgel', categoryId: 'cat_drogerie', date: subDays(now, 4).toISOString(), isDemo: true, lastModified: now.toISOString(), version: 1, createdBy: standardUser },
        ...
        { id: 'dev-8', amount: 42.00, description: 'Geburtstagsgeschenk für Mama', categoryId: 'cat_geschenke', date: subDays(now, 6).toISOString(), isDemo: true, lastModified: now.toISOString(), version: 1, createdBy: standardUser },
        { id: 'dev-9', amount: 330.00, description: 'Hotel für Wochenende in Berlin', categoryId: 'cat_urlaub', date: subDays(now, 7).toISOString(), isDemo: true, tagIds: ['dev-tag-1', 'dev-tag-3'], lastModified: now.toISOString(), version: 1, createdBy: standardUser },
        { id: 'dev-10', amount: 18.00, description: 'Kino: Neuer Superheldenfilm', categoryId: 'cat_kultur', date: subDays(now, 8).toISOString(), isDemo: true, tagIds: ['dev-tag-3'], lastModified: now.toISOString(), version: 1, createdBy: standardUser },
        { id: 'dev-11', amount: 22.50, description: 'Medikamente aus der Apotheke', categoryId: 'cat_gesundheit', date: subDays(now, 9).toISOString(), isDemo: true, lastModified: now.toISOString(), version: 1, createdBy: standardUser },
        ...
        { id: 'dev-13', amount: 35.00, description: 'Monatsticket ÖPNV', categoryId: 'cat_oepnv', date: subDays(now, 11).toISOString(), isDemo: true, tagIds: ['dev-tag-4'], lastModified: now.toISOString(), version: 1, createdBy: standardUser },
        ...
        { id: 'dev-15', amount: 29.99, description: 'Spotify Abo', categoryId: 'cat_abos', date: subDays(now, 13).toISOString(), isDemo: true, lastModified: now.toISOString(), version: 1, createdBy: standardUser },
        ...
        { id: 'dev-17', amount: 49.99, description: 'Netflix Jahresabo', categoryId: 'cat_abos', date: subDays(now, 15).toISOString(), isDemo: true, lastModified: now.toISOString(), version: 1, createdBy: standardUser },
        { id: 'dev-18', amount: 25.50, description: 'Haarschnitt', categoryId: 'cat_friseur', date: subDays(now, 16).toISOString(), isDemo: true, lastModified: now.toISOString(), version: 1, createdBy: standardUser },
    ];
};
