...
export const DayDetailPanel: FC<DayDetailPanelProps> = ({ isOpen, date, transactions, onClose }) => {
    const { handleTransactionClick, deLocale } = useApp();
        ...
        >
            ...
            <header className="p-6 border-b border-slate-700 flex-shrink-0">
                <div className="flex justify-between items-start">
                    <div>
                        <h2 id="day-detail-title" className="text-xl font-bold text-white">{formatGermanDate(date, deLocale)}</h2>
