...
const tempRecipes: readonly OldRecipe[] = [
    // Temporary recipes are moved to oldRecipes below. This list is ready for new additions.
];
// =========================================================================================
...
const oldRecipes: readonly OldRecipe[] = [
    ...
    // Newly added permanent recipes
    { id: 'r066', title: "Milchreisauflauf mit Apfel ohne Vorkochen", base: 'reis', tags: ['Vegetarisch', 'Süßspeise', 'Ofengericht'], estimatedPricePerServing: 1.8, ingredients: [
    ...
    { id: 'r067', title: "Einfache Kartoffelsuppe", base: 'kartoffeln', tags: ['Vegetarisch', 'Suppe', 'Günstig'], estimatedPricePerServing: 1.5, ingredients: [
    ...
    { id: 'r068', title: "Supersaftiger Apfelkuchen", base: 'mix', tags: ['Vegetarisch', 'Süßspeise', 'Kuchen'], estimatedPricePerServing: 1.2, ingredients: [
    ...
    { id: 'r069', title: "Kürbisgulasch", base: 'mix', tags: ['Vegetarisch', 'Eintopf', 'Herbst', 'Vegan'], estimatedPricePerServing: 2.2, ingredients: [
    ...
    { id: 'r070', title: "Reis-Gemüse-Pfanne mit Frischkäse", base: 'reis', tags: ['Vegetarisch', 'Schnell', 'Pfannengericht'], estimatedPricePerServing: 2.0, ingredients: [
    ...
    { id: 'r071', title: "Rindergulasch", base: 'kartoffeln', tags: ['Fleisch', 'Eintopf', 'Klassiker'], estimatedPricePerServing: 3.8, ingredients: [
    ...
    { id: 'r072', title: "Hähnchenschenkel im Backofen mit Gemüse", base: 'kartoffeln', tags: ['Fleisch', 'Ofengericht'], estimatedPricePerServing: 2.7, ingredients: [
    ...
    { id: 'r073', title: "Klassische italienische Lasagne", base: 'nudeln', tags: ['Fleisch', 'Ofengericht', 'Klassiker', 'Italienisch'], estimatedPricePerServing: 3.5, link: "https://www.kitchenstories.com/de/rezepte/klassische-italienische-lasagne", ingredients: [
    ...
    { id: 'r074', title: "Puten-Sahne-Gulasch auf Bandnudeln", base: 'nudeln', tags: ['Fleisch', 'Schnell'], estimatedPricePerServing: 3.1, ingredients: [
    ...
    { id: 'r075', title: "Veganer Birnenkuchen ohne Zucker", base: 'mix', tags: ['Vegan', 'Süßspeise', 'Kuchen', 'Zuckerfrei'], estimatedPricePerServing: 1.9, ingredients: [
    ...
    { id: 'r076', title: "Zuckerfreier Geburtstagskuchen für Kinder", base: 'mix', tags: ['Vegetarisch', 'Süßspeise', 'Kuchen', 'Zuckerfrei', 'Kinder'], estimatedPricePerServing: 2.0, ingredients: [
    ...
    { id: 'r077', title: 'Kartoffel-Brokkoli-Auflauf', base: 'kartoffeln', tags: ['Vegetarisch', 'Ofengericht', 'Käse'], estimatedPricePerServing: 2.1, ingredients: [
    ...
    { id: 'r078', title: 'Reis-Hackfleisch-Pfanne mit Paprika', base: 'reis', tags: ['Fleisch', 'Schnell', 'Pfannengericht'], estimatedPricePerServing: 2.5, ingredients: [
    ...
    { id: 'r079', title: 'Hackbällchen Toskana', base: 'reis', tags: ['Fleisch', 'Ofengericht', 'Italienisch', 'Käse'], estimatedPricePerServing: 3.3, ingredients: [
    ...
    { id: 'r080', title: 'Rote Linsen Bolognese mit Pasta', base: 'nudeln', tags: ['Vegetarisch', 'Vegan', 'Günstig'], estimatedPricePerServing: 1.5, ingredients: [
    ...
    { id: 'r081', title: 'Paella mit Hähnchen und Erbsen', base: 'reis', tags: ['Fleisch', 'Pfannengericht', 'Spanisch'], estimatedPricePerServing: 3.6, ingredients: [
    ...
    { id: 'r082', title: 'Apfelpfannküchlein', base: 'mix', tags: ['Vegetarisch', 'Süßspeise', 'Schnell'], estimatedPricePerServing: 1.4, ingredients: [
    ...
    { id: 'r083', title: 'Italienischer Auberginenauflauf', base: 'mix', tags: ['Vegetarisch', 'Ofengericht', 'Italienisch', 'Käse'], estimatedPricePerServing: 2.8, ingredients: [
    ...
    { id: 'r084', title: 'Hähnchen mit Erbsen und Senf-Sahne-Sauce', base: 'reis', tags: ['Fleisch', 'Schnell', 'Pfannengericht'], estimatedPricePerServing: 2.9, ingredients: [
    ...
    { id: 'r085', title: 'Reispfanne', base: 'reis', tags: ['Vegetarisch', 'Schnell', 'Pfannengericht', 'Vegan'], estimatedPricePerServing: 1.8, ingredients: [
    ...
    { id: 'r086', title: 'Nudeln mit Lachs-Sahne-Sauce', base: 'nudeln', tags: ['Fisch', 'Schnell'], estimatedPricePerServing: 3.4, ingredients: [
    ...
    { id: 'r087', title: 'Ofenkartoffeln', base: 'kartoffeln', tags: ['Vegetarisch', 'Ofengericht', 'Günstig', 'Vegan'], estimatedPricePerServing: 1.6, ingredients: [
    ...
    { id: 'r088', title: 'Gebratener Reis', base: 'reis', tags: ['Vegetarisch', 'Schnell', 'Günstig'], estimatedPricePerServing: 1.7, ingredients: [
    ...
    { id: 'r089', title: 'Hähnchen-Reis-Pfanne mit Brokkoli und Mais', base: 'reis', tags: ['Fleisch', 'Schnell', 'Pfannengericht'], estimatedPricePerServing: 2.6, ingredients: [
    ...
    { id: 'r090', title: 'Gnocchi-Auflauf', base: 'kartoffeln', tags: ['Vegetarisch', 'Ofengericht', 'Käse', 'Schnell'], estimatedPricePerServing: 2.5, ingredients: [
    ...
    { id: 'r091', title: 'Ratatouille', base: 'mix', tags: ['Vegetarisch', 'Vegan', 'Ofengericht', 'Gesund'], estimatedPricePerServing: 2.3, ingredients: [
    ...
    { id: 'r092', title: 'Klassisches Putenbrustgulasch', base: 'reis', tags: ['Fleisch', 'Eintopf'], estimatedPricePerServing: 3.0, ingredients: [
    ...
    { id: 'r093', title: 'Blumenkohlauflauf mit Kartoffeln', base: 'kartoffeln', tags: ['Vegetarisch', 'Ofengericht', 'Käse', 'Günstig'], estimatedPricePerServing: 2.2, ingredients: [
...
export const getSeedRecipes = (): Recipe[] => {
    ...
    return allRecipes.map(r => ({
        id: r.id,
        name: r.title,
        ingredients: r.ingredients.map(i => ({ name: i.name, category: i.category })),
