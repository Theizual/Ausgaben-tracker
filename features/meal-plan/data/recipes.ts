...
export const recipes: readonly Recipe[] = [
    ...
    { id: 'r017', title: 'Lasagne al Forno', link: 'https://www.chefkoch.de/rezepte/122131052213812/Lasagne.html', base: 'nudeln', tags: ['meat'], gramsPerServing: 350, pricePer100g: 1.9, sideSuggestion: 'Grüner Salat' },
    { id: 'r018', title: 'Käsespätzle mit Röstzwiebeln', link: 'https://www.chefkoch.de/rezepte/1173221223291263/Kaesespaetzle.html', base: 'nudeln', tags: ['vegetarian', 'cheap'], gramsPerServing: 300, pricePer100g: 1.2, sideSuggestion: 'Gurkensalat' },
    ...
    { id: 'r019', title: 'Chicken Teriyaki Bowl', link: 'https://www.eat.de/rezept/chicken-teriyaki-bowl/', base: 'reis', tags: ['meat', 'quick'], gramsPerServing: 300, pricePer100g: 2.1, sideSuggestion: 'Edamame' },
    { id: 'r023', title: 'Meeresfrüchte-Paella', link: 'https://www.chefkoch.de/rezepte/1093951215494322/Paella-mit-Meeresfruechten.html', base: 'reis', tags: ['fish'], gramsPerServing: 350, pricePer100g: 2.8 },
    ...
    { id: 'r020', title: 'Shepherd\'s Pie', link: 'https://www.chefkoch.de/rezepte/1261351231362772/Shepherd-s-Pie.html', base: 'kartoffeln', tags: ['meat'], gramsPerServing: 400, pricePer100g: 1.7, sideSuggestion: 'Grüne Bohnen' },
    { id: 'r022', title: 'Gulasch mit Kartoffeln', link: 'https://www.chefkoch.de/rezepte/1107511216891293/Gulasch.html', base: 'kartoffeln', tags: ['meat'], gramsPerServing: 450, pricePer100g: 2.0 },
    ...
    { id: 'r021', title: 'Shakshuka', link: 'https://www.eat.de/rezept/shakshuka/', base: 'mix', tags: ['vegetarian', 'cheap', 'quick'], gramsPerServing: 350, pricePer100g: 1.1, sideSuggestion: 'Fladenbrot' },
    { id: 'r024', title: 'Pizza Margherita', link: 'https://www.chefkoch.de/rezepte/212951088749929/Pizzateig.html', base: 'mix', tags: ['vegetarian', 'quick', 'cheap'], gramsPerServing: 300, pricePer100g: 1.0 },
] as const;
