...
const Logo: React.FC<{ className?: string }> = ({ className }) => {
  return (
    <svg 
      ...
      className={`h-8 sm:h-10 w-auto ${className || ''}`.trim()}
      role="img"
      aria-label="Ausgaben Tracker Logo"
    >
      <defs>
      ...
      <text
        ...
        letterSpacing="0"
      >
        <tspan fontWeight="600" fill="#FFFFFF">Ausgaben</tspan>
        <tspan dx="6" fontWeight="400" fill="#A0A9B8">Tracker</tspan>
      </text>
    </svg>
  );
};
